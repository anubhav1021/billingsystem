...
public class view_information extends JFrame implements ActionListener{
    ...
    view_information(String view){
        ...
        try{
            ...
            ResultSet resultSet = c.statement.executeQuery("select * from new_customer1 where meter_no = '"+view+"'");
            if (resultSet.next()){
        ...
        add(cancel);
        // ImageIcon a1 = new ImageIcon(ClassLoader.getSystemResource("icons/sarso.jpg"));
